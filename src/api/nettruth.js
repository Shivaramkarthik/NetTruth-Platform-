// Use environment variable in dev; fall back to the deployed Render backend in production.
const API_URL = import.meta.env.VITE_API_URL || "https://nettruth-platform.onrender.com";
